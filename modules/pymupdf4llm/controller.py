...
async def extract_data(
    body: PyMuPDF4LLMExtractionRequest = Depends(PyMuPDF4LLMExtractionRequest.as_form),
    ...
    extracted_markdown = await asyncio.to_thread(PyMuPDF4LLMExtractor().extract, pdf_bytes)
